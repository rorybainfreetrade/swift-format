...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftFormatTestSupport",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22SwiftFormatTestSupport18DiagnosingTestCase")
@interface DiagnosingTestCase : XCTestCase
...
@property (nonatomic) BOOL shouldCheckForUnassertedDiagnostics;
- (void)setUp;
- (void)tearDown;
